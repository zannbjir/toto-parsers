...
internal class ManhwadesuParser(context: MangaLoaderContext) :
    ...
    override val configKeyDomain = ConfigKey.Domain("manhwadesu.art")
        ...
        return try {
            val url = when {
                !filter.query.isNullOrEmpty() -> {
                    ...
                    "https://$domain/komik/page/$page".toHttpUrl()
                }
            }
            ...
            // MangaThemesia template: .post-title or .series-title
    ...
    override suspend fun getPages(chapter: MangaChapter): List<MangaPage> {
        return try {
            ...
            // Try to find images in common containers
