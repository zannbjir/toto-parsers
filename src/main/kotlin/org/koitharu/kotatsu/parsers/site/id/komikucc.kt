...
internal class Komikucc(context: MangaLoaderContext) :
    ...
    // Dihilangkan override-nya karena bukan bawaan dari SinglePageMangaParser
    private val states: Set<MangaState> = EnumSet.of(
        MangaState.ONGOING,
        MangaState.FINISHED,
        MangaState.PAUSED,
    )

    private val contentTypes: Set<ContentType> = EnumSet.of(
        ContentType.MANGA,
        ContentType.MANHWA,
        ContentType.MANHUA,
    )
    ...
    private suspend fun getListPage(page: Int, order: SortOrder, filter: MangaListFilter): List<Manga> {
        ...
        // Fix error 'Search' dan 'Advanced' (Ini cara pakai Kotatsu)
