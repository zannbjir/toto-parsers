...
@MangaSourceParser("ZONAKOMIK", "ZonaKomik", "id", ContentType.HENTAI)
internal class ZonaKomikParser(context: MangaLoaderContext) :
	PagedMangaParser(context, MangaParserSource.ZONAKOMIK, pageSize = 20) {

	override val configKeyDomain = ConfigKey.Domain("zonakomik.com")
