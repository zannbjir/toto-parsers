...
internal class Softkomik(context: MangaLoaderContext) :
    ...
    // API asli yang dipakai web softkomik.co
    ...
    override suspend fun getDetails(manga: Manga): Manga {
        // Softkomik narik chapter lewat endpoint API v2 mereka
        val response = webClient.httpGet("$apiUrl/komik/${manga.url}/chapter?limit=9999", getApiHeaders())
        val body = response.body?.string() ?: ""
        val chaptersArray = JSONObject(body).optJSONArray("chapter") ?: JSONArray()
    ...
    override suspend fun getPages(chapter: MangaChapter): List<MangaPage> {
        ...
        // Ambil data JSON dari tag script Next.js
        ...
        // Host gambar Softkomik sering berubah antara image atau f1
